...
<main>
  <div class="container">
  <!-- product api not up internal erro 500 -->
  <!-- <h2 class="visually-hidden">Каталог игрушек.</h2> -->
  <div class="row row-cols-lg-4 g-2">
    <div class="col">
      <div class="card">
        <a class="card-item-link" href="#">
          <img class="card-img-top img-fluid" src="https://htmlacademy.ru/assets/skills/33/case-02/demo/img/photo-11.jpg" alt="" aria-labelledby="title_1" width="270" height="200">
        </a>
        <div class="card-body">
          <div class="card-item-header">
            <p class="card-item-code">product id</p>
            <div class="rate">
              <p class="card-item-rating">
                <img src="https://cdn-icons-png.flaticon.com/512/1828/1828884.png" alt=""> <b>4.9</b>
              </p>
              <!-- <a class="card-item-code link" href="#">19 отзывов</a> -->
            </div>
          </div>
          <h3 class="card-title" id="title_1">product name</h3>
          <div class="card-item-footer">
            <p class="card-item-price">item price</p>
            <button class="card-item-btn card-item-button--favourite btn" type="button">
            ...
            <button class="card-item-btn card-item-button--cart btn" type="button">
              <img src="https://cdn-icons-png.flaticon.com/512/4296/4296588.png" alt="" @click='addTCart'>
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card">
        <p class="card-item-chevron card-item-chevron--sale">Скидка 50%</p>
        <a class="card-item-link" href="#">
          <img class="card-img-top img-fluid" src="https://htmlacademy.ru/assets/skills/33/case-02/demo/img/photo-10.jpg" alt="" aria-labelledby="title_2" width="270" height="200">
        </a>
        <div class="card-body">
          <div class="card-item-header">
            <p class="card-item-code">product id</p>
            <div class="rate">
              <p class="card-item-rating">
                <img src="https://cdn-icons-png.flaticon.com/512/1828/1828884.png" alt=""> <b>4.8</b>
              </p>
              <a class="card-item-code link" href="#"></a>
            </div>
          </div>
          <h3 class="card-title" id="title_2">product name</h3>
          <div class="card-item-footer">
            <p class="card-item-price">item price<s></s></p>
            <button class="card-item-btn card-item-button--favourite btn" type="button">
              <img src="https://cdn-icons-png.flaticon.com/512/1216/1216575.png" alt="">
            </button>
            <button class="card-item-btn card-item-button--cart btn" type="button">
    ...
    <div class="col">
      <div class="card">
        <a class="card-item-link" href="#">
          <img class="card-img-top img-fluid" src="https://htmlacademy.ru/assets/skills/33/case-02/demo/img/photo-9.jpg" alt="" aria-labelledby="title_2" width="270" height="200">
        </a>
        <div class="card-body">
          <div class="card-item-header">
            <p class="card-item-code">product id</p>
...
export default {
  ...
  mounted() {
    axios.get('https://new-fullstack-pos-backend-api.herokuapp.com/products')
    .then((response) => {
